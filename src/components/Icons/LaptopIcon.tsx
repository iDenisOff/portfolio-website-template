...
export const LaptopIcon: React.FC<LaptopIconProps> = ({ width = 357, height = 234 }) => (
    <svg width={width} height={height} viewBox="0 0 357 234" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M337.3 225.4H24.1C19.9 225.4 16.5 222 16.5 217.8V7.6C16.5 3.4 19.9 0 24.1 0H337.3C341.5 0 344.9 3.4 344.9 7.6V217.7C345 222 341.5 225.4 337.3 225.4Z"
            fill="#00D5E4"
        />
        <path
            d="M326.2 217.8H35.2C31 217.8 27.6 214.4 27.6 210.2V15.3C27.6 11.1 31 7.70001 35.2 7.70001H326.2C330.4 7.70001 333.8 11.1 333.8 15.3V210.2C333.9 214.3 330.4 217.8 326.2 217.8Z"
            fill="#065090"
        />
        ...
        <g opacity="0.1">
            ...
            <g opacity="0.1">
                <path
                    opacity="0.1"
                    d="M35.3 217.8H48.6L123.2 7.59998H35.3C31.1 7.59998 27.7 11 27.7 15.2V210.1C27.6 214.3 31.1 217.8 35.3 217.8Z"
                    fill="white"
                />
            </g>
            <g opacity="0.1">
